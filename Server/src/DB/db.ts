...
`);
  ...
  //RESERVATIONS
  await db.none(
    `INSERT INTO reservation (id_doctor,id_patient,date_reservation) VALUES (1,null,'2023-05-25 11:00:00')`
  );
  await db.none(
  ...
  await db.none(
    `INSERT INTO reservation (id_doctor,id_patient,date_reservation) VALUES (2,null,'2023-05-25 11:30:00')`
  );
